    ...
    style={{backgroundImage:`url(${img})`}}>
      <div className='flex flex-col justify-center items-center w-full h-full'>
        <div className='max-w-[1000px] w-full grid grid-cols-2 gap-2'>
          <div className='sm:text-right pb-8 pl-4 sm:text-10'>
          ...
          <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
            <div className='sm:text-right text-4xl font-extrabold font-serif'>
              <p>Hey. I'm Eshan Singh, nice to meet you. Please take a look around.</p>
            </div>
            <div>
              <p className='text-xl font-serif'>I am passionate about building excellent software that improves
